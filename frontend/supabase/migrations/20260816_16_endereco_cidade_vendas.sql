-- Visual Esquadrias
-- Adiciona endereço e cidade às vendas e atualiza a gravação transacional.
...
drop function if exists public.salvar_venda_com_parcelas(
...
revoke all on function public.salvar_venda_com_parcelas(
  bigint, date, text, numeric, text, text, text, text, jsonb
) from public;
